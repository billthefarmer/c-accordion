...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Accordion"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\Accordion.exe"
...
Name "${PRODUCT_NAME}"
OutFile "SetupAccordion.exe"
InstallDir "$PROGRAMFILES\Accordion"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\Accordion.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\Accordion.exe"
